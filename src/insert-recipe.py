...
recipe_sql_template = 'INSERT INTO recipe (id, title, instructions, total_energy, energy_per_serving, protein, fat, carbohydrates) VALUES ({id}, "{title}", "{instructions}", {nutrients[Totalkcal]}, {nutrients[kcal]}, {nutrients[protein]}, {nutrients[carbohydrates]};'
ingredient_sql_template = 'INSERT INTO ingredient (recipe_id, amount, unit, name) VALUES ({id}, {amount}, "{unit}", "{name});'
